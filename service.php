...
<div class="products-page">
    <div class="product-header">
        <div class="row">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <!-- Search  -->
            <div class="col">
                <h3 class="page-title"><?php echo "Services"?></h3>
            </div>
            ...
            <div class="col-lg-4  col-12">
                ...
                <div class="input-group md-form form-sm form-1 pl-0 search-box user-search-panel">
                    <input class="form-control my-0 py-1" type="text" id="keywords" placeholder="Search by Service"
    ...
    <div class="user-wrapper">
        ...
        //get number of rows
        $queryNum = $mysqli->query("SELECT COUNT(*) as userNum FROM services");
        ...
        $counter = 0;
        //get rows
        $query = $mysqli->query("select services.id as id, services.name as ProductName, services.name_ar as ProductNameAr, services.price as product_price from services where services.archive = 0 LIMIT ".$limit);
                    ...
                    <table class="table table-hover ">
                        <thead>
                            <tr>
                                ...
                                <th style="width:15em"><?php echo"Service";?></th>
                 ...
                 // echo $test2;
                  ...
                  ?>
                        ...
                        <tr style="cursor: pointer;"
                            ...
                            <!-- <td class="w-30"><?php echo $row['id']; ?></td> -->
                            <td class="w-50">
                            ...
                            <td class="w-50"><?php echo $price; ?></td>
                            <!-- <td><?php echo $stock; ?></td> -->
                            <td class='hidden-xs align-content-end w-50'>
                                <div class='dropdown'>
