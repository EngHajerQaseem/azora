...
class FontVariables
{
	...
	public function __construct()
	{
		$this->defaults = [
			...
			'backupSubsFont' => ['lateef', 'sun-exta'],
			...
			'sans_fonts' => [ 'sans', 'sans-serif', 'cursive', 'fantasy', 'lateef', 'liberationsans',
			...
			'serif_fonts' => ['dejavuserifcondensed', 'serif', 'lateef', 'liberationserif',
			...
			'mono_fonts' => ['dejavusansmono', 'mono', 'monospace', 'liberationmono', 'courier', 'ocrb', 'ocr-b', 'lucidaconsole',
