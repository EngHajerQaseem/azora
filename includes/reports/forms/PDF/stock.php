...
"html,body{font-family:DejaVuSans}#bigi{margin-bottom:20px;font-size:28px;
	...
	#items td,#items th{padding:10px}#items th{text-align:left;border-top:2px solid #000;border-bottom:2px solid #000}#items td{border-bottom:1px solid #ccc}
...
"</style><script src='https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js'></script></head><body><div id='invoice'>";
...
// ITEMS
// $this->data .= "<table id='items'><tr><th>Reference No</th><th>Customer</th><th>Product Name</th><th>Warehouse</th><th>Date</th></tr>";
