...
<div class="products-page">
    <div class="product-header">
        <div class="row">
            ...
            <div class="col-lg-4 col-12">
                ...
                <h3 class="page-title"><?php echo _("Page_Title_Suppliers");?></h3>
            </div>
            ...
            <div class="col-lg-4 col-12">
                <div class="input-group md-form form-sm form-1 pl-0 search-box user-search-panel">
                    <input class="form-control my-0 py-1" type="text" id="keywords"
                        placeholder="<?php echo _("supplier_search_by_supplier_name"); ?>" onkeyup="searchFilter()" />
    ...
    <div class="user-wrapper">
        <div class="loading-overlay">
            <div class="overlay-content"><?php echo _("suppliers_loading");?></div>
        </div>
        <div id="suppliers_content">
            <?php
                ...
                //get number of rows
                $queryNum = $mysqli->query("SELECT COUNT(*) as userNum FROM suppliers");
                ...
                //get rows
                $query = $mysqli->query("SELECT * FROM suppliers WHERE archive = 0 ORDER BY id ASC LIMIT $limit");
                    ...
                    <table class="table table-hover ">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-xs" style="width:10em" scope="col"><?php echo _("suppliers_action");?>
                                </th>
                            </tr>
                        </thead>
                        <?php
                        ...
                        <tr style="cursor: pointer;"
                            ...
                            <!-- <td> <?php //echo _("suppliers_admin");?> </td> -->
...
$(document).ready(function() {
    $('.delete_supp').click(function(e) {
        e.preventDefault();
        var suppid = $(this).attr('data-supp-id');
        var parent = $(this).parent(".dropdown-menu").parent(".dropdown").parent("td").parent("tr");
        bootbox.dialog({
            message: "<div class='delete_user_popup'><div class='icon-trash'><i class='fas fa-trash'></i></div><div class='delete-text'><?php echo _("suppliers_delete_alert_message");?></div></div>",
            title: "<i class='glyphicon glyphicon-trash'></i>",
            buttons: {
                success: {
                    label: "<?php echo _("suppliers_cancel");?>",
                ...
                danger: {
                    label: "<?php echo _("suppliers_delete");?>!",
                    className: "btn-danger",
                    callback: function() {
                        $.ajax({
                                type: 'POST',
                                url: 'supplier_rmv.php',
                                data: 'suppid=' + suppid
                            })
                            ...
                            .fail(function() {
                                bootbox.alert('<?php echo _("suppliers_error");?>');
                            })
                    }
                }
            }
